...
const BoothInfoDetail = () => {
  ...
  return (
    <div className="fp-info pb-5">
      ...
      {isBooth && isEdit && corps.length > 0 ? <CorpInfo className="p-2 text-large" name="org" value={org} placeholder="請輸入單位全名" corpId={corpId} /> : <div className="p-2 text-large">{org}</div>}
