...
export const Selector = ({ graphRef, svgRef }) => {
  ...
  return (
    <>
      ...
      <div className="fp-zoom">
        ...
        <span className="d-flex justify-content-center align-items-center text-xx-large shadow" onClick={() => resetViewbox({ svg: svgRef.current, animate: true })}>
